...
public class ch_3_loadTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Object obj = myClassLoader.loadClass("top.wujinxing.classload.TestBean").newInstance();
        System.out.println(obj.getClass());
        System.out.println(obj.getClass().getClassLoader());
        System.out.println(obj instanceof top.wujinxing.classload.TestBean);
        /**
         * class top.wujinxing.classload.TestBean
         * top.wujinxing.classload.ch_3_loadTest$1@3fee733d
         * false

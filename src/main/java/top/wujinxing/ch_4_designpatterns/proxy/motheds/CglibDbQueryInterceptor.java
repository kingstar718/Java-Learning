package top.wujinxing.ch_4_designpatterns.proxy.motheds;

import net.sf.cglib.proxy.Enhancer;
import net.sf.cglib.proxy.MethodInterceptor;
import net.sf.cglib.proxy.MethodProxy;
import top.wujinxing.ch_4_designpatterns.proxy.example.DBQuery;
import top.wujinxing.ch_4_designpatterns.proxy.example.IDBQuery;
